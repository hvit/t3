...
Two middleware functions are provided by default in the `cljdemo.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `cljdemo.handler` namespace to manage the enabled middleware.
